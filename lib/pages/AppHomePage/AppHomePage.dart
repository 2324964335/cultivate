  ...
  static List<Map<String, dynamic>> barData = [
    {
      'index':0,
      'title': '首页',
      'icon': Image.asset("asset/images/tabbar/tabbar_home.png",width: 44.sp,height: 44.sp,),
      'selectIcon':Image.asset("asset/images/tabbar/tabbar_home_select.png",width: 44.sp,height: 44.sp,),
      'body': Home(),
    },
    {
      'index':1,
  ...
  Widget _scaffoldBody() {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedItemColor:Color(0xFFFF5B3E),
    ...
    try {
      return barData.map<BottomNavigationBarItem>((itemData) {
        return BottomNavigationBarItem(
          icon:currentIndex == itemData["index"]?
            itemData['selectIcon']:itemData['icon'], // 图标
