...
class CultivateSecondMangerGangChildWidget extends StatefulWidget {
  final int index;
  CultivateSecondMangerGangChildWidget(this.index);
  @override
  _CultivateSecondMangerGangChildWidgetState createState() => _CultivateSecondMangerGangChildWidgetState();
}

class _CultivateSecondMangerGangChildWidgetState extends State<CultivateSecondMangerGangChildWidget>  with AutomaticKeepAliveClientMixin {
  @override
