...
const serviceUrl = {
   ...
   'app_home_bottom':appurlPro + 'Education/Main/GetMonthList', ///首页底部数据
   ...
   'app_home_item_detail':appurlPro + 'Notice/NoticeList/EduItemDetail', ///首页列表明细详情
   'app_home_item_detail_see':appurlPro + 'Notice/NoticeList/Detail/EduItemSee', ///首页列表明细详情查看
   'app_home_item_detail_zan':appurlPro + 'Notice/NoticeList/Detail/EduItemLikes', ///首页列表明细详情点赞
   'app_home_item_detail_comment':appurlPro + 'Notice/NoticeList/Detail/EduItemComment', ///首页列表明细详情评论
   ...
   'app_home_information_byWords':appurlPro + 'Education/Main/QryEduList', ///首页公告关键词搜索
